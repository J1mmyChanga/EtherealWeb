...
class CustomLooksForm(FlaskForm):
    style = RadioField('Стиль:', choices=[(1, 'Деловой'), (2, 'Свободный'), (3, 'Спортивный')], validators=[DataRequired()])
    season = RadioField('Сезон:', choices=[(1, 'Летний'), (2, 'Зимний'), (3, 'Демисезонный')], validators=[DataRequired()])
