...
session.add(season2)
season4 = Season(id=3, season='Демисезонная', look_season='Демисезонный')
session.add(season4)
...
c1 = Clothes(id=1, name='Пальто', type=1, season=3)
c2 = Clothes(id=2, name='Пуховик', type=1, season=2)
c3 = Clothes(id=3, name='Плащ', type=1, season=3)
c4 = Clothes(id=4, name='Бомбер', type=1, season=3)
c5 = Clothes(id=5, name='Ветровка', type=1, season=1)
c6 = Clothes(id=6, name='Косуха', type=1, season=3)
c7 = Clothes(id=7, name='Парка', type=1, season=3)
c8 = Clothes(id=8, name='Блуза', type=2, season=3)
c9 = Clothes(id=9, name='Классические брюки', type=3, season=3)
c10 = Clothes(id=10, name='Джемпер', type=2, season=3)
c11 = Clothes(id=11, name='Жилет', type=2, season=3)
c12 = Clothes(id=12, name='Кардиган', type=2, season=3)
c13 = Clothes(id=13, name='Кофта', type=2, season=2)
c14 = Clothes(id=14, name='Пиджак', type=2, season=3)
...
c22 = Clothes(id=22, name='Пуловер', type=2, season=3)
c23 = Clothes(id=23, name='Милитари', type=3, season=3)
...
l21 = Looks(id=21, style=1, season=3, sex=3)
l22 = Looks(id=22, style=3, season=3, sex=3)
l23 = Looks(id=23, style=2, season=3, sex=3)
l24 = Looks(id=24, style=2, season=3, sex=1)
l25 = Looks(id=25, style=2, season=3, sex=1)
l26 = Looks(id=26, style=2, season=3, sex=1)
l27 = Looks(id=27, style=2, season=3, sex=3)
l28 = Looks(id=28, style=1, season=3, sex=1)
for i in range(1, 29):
