...
api = Api(app)
api.add_resource(GetFavorite, "/api/getFavoriteLooks/")
api.add_resource(RemoveFavoriteLookResource, "/api/removeFavoriteLook/")
api.add_resource(GetCustomLooksResource, "/api/getCustomLooks/")
